# Adoption snapshot, 2026-09-18

> This is an adoption record, not part of the standard. It is kept so the
> findings are not lost before each image repository tracks its own gaps,
> and it is deleted once they do. See [adoption](README.md).

Where each Datopsis image repository stood against [the criteria](../standard/criteria.md)
...
| --- | --- | --- | --- | --- | --- |
| [IMG-01](../standard/criteria.md#img-01-base-image-pinned-by-digest) Base pinned | Met | Met | Partial | Met | Met |
| [IMG-02](../standard/criteria.md#img-02-every-build-input-pinned-and-verified) Inputs verified | Met | Met | No | Partial | Partial |
| [IMG-03](../standard/criteria.md#img-03-hermetic-assembly) Hermetic | Met | Met | No | Partial | Partial |
| [IMG-06](../standard/criteria.md#img-06-no-package-manager) No package manager | Met | Met | Partial | No | Partial |
| [IMG-09](../standard/criteria.md#img-09-no-privilege-raising-files) No setuid | No | Met | No | No | No |
| [IMG-10](../standard/criteria.md#img-10-software-and-configuration-not-writable-by-the-service) Not writable | Met | ? | No | ? | Met |
| [IMG-11](../standard/criteria.md#img-11-non-root-with-no-privilege-transition) Non-root | Met | Met | Partial | Partial | Met |
| [IMG-12](../standard/criteria.md#img-12-runs-under-an-arbitrary-uid) Arbitrary UID | Met | Met | Met | ? | Met |
| [IMG-13](../standard/criteria.md#img-13-works-with-no-capabilities-and-no-new-privileges) No capabilities | Met | Met | Partial | Partial | Met |
| [IMG-14](../standard/criteria.md#img-14-unprivileged-ports) Unprivileged ports | Partial | Partial | Partial | Partial | Partial |
| [IMG-15](../standard/criteria.md#img-15-read-only-root-filesystem) Read-only root | Met | Met | Partial | Met | Met |
| [IMG-16](../standard/criteria.md#img-16-secrets-only-as-read-only-files) Secrets as files | Met | Met | No | Partial | No |
| [IMG-20](../standard/criteria.md#img-20-lifecycle-is-declared) Lifecycle | Met | Met | Partial | No | Met |
| [IMG-22](../standard/criteria.md#img-22-signed-with-provenance) Signed | Partial | Met | Met | No | No |
| [IMG-23](../standard/criteria.md#img-23-identifying-labels) Labels | Partial | Met | Partial | Partial | Partial |
| [IMG-25](../standard/criteria.md#img-25-vulnerability-gate-and-remediation) Vulnerabilities | Partial | Met | Partial | No | Partial |
...
**postgresql-ubi met the most of the remaining criteria.** It was the only image
...
**nginx-ubi met the build criteria most fully.** Its lock, hermetic assembly,
and negative build tests met IMG-01 to IMG-04. Its release workflow
...
- **Digest pinning.** Two obligations, named separately: the image pins its base
  ([IMG-01](../standard/criteria.md#img-01-base-image-pinned-by-digest)); the deployment
  pins the image ([PLT-01](../standard/platform.md#plt-01-images-are-admitted-by-verified-digest)).
- **Capabilities and `no-new-privileges`.** The image *works under* them and
  tests that ([IMG-13](../standard/criteria.md#img-13-works-with-no-capabilities-and-no-new-privileges));
  the platform *imposes* them ([PLT-02](../standard/platform.md#plt-02-least-privilege-is-imposed)).
...
- **SCAP.** Two images claim SCAP evidence in their agent guidance that their CI
  ...
  stays a [target](../standard/criteria.md#img-t3-compliance-scan) until one selection is
  agreed.
